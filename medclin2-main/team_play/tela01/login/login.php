                    ...
                    <div class="section text-center">
                      ...
                      <form action="login.php" method="post"> <!-- Definindo o método POST -->
                        <div class="form-group">
                          <input type="email" class="form-style" placeholder="E-mail" name="email"> <!-- Adicionando o atributo name -->
                          <i class="input-icon uil uil-at"></i>
                        </div>
                        <div class="form-group mt-2">
                          <input type="password" class="form-style" placeholder="Senha" name="password"> <!-- Adicionando o atributo name -->
                          <i class="input-icon uil uil-lock-alt"></i>
                        </div>
                        <button type="submit" class="btn mt-4">Entrar</button>
                      </form>
                      <p class="mb-0 mt-4 text-center"><a href="#" class="link">Esqueceu sua
                          senha?</a></p>
                    </div>
                  </div>
                </div>
